...
type UserServiceClient interface {
	...
	ValidateLoginCredentials(ctx context.Context, in *ValidateLoginCredentialsRequest, opts ...grpc.CallOption) (*ValidateLoginCredentialsResponse, error)
}
...
func (c *userServiceClient) ValidateLoginCredentials(ctx context.Context, in *ValidateLoginCredentialsRequest, opts ...grpc.CallOption) (*ValidateLoginCredentialsResponse, error) {
	out := new(ValidateLoginCredentialsResponse)
	err := c.cc.Invoke(ctx, "/pb.UserService/ValidateLoginCredentials", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	ValidateLoginCredentials(context.Context, *ValidateLoginCredentialsRequest) (*ValidateLoginCredentialsResponse, error)
...
func (UnimplementedUserServiceServer) ValidateLoginCredentials(context.Context, *ValidateLoginCredentialsRequest) (*ValidateLoginCredentialsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateLoginCredentials not implemented")
}
...
func _UserService_ValidateLoginCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateLoginCredentialsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).ValidateLoginCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/ValidateLoginCredentials",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ValidateLoginCredentials(ctx, req.(*ValidateLoginCredentialsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidateLoginCredentials",
			Handler:    _UserService_ValidateLoginCredentials_Handler,
		},
	},
